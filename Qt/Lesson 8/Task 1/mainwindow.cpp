    ...
    , ui(new Ui::MainWindow)
{
    ...
    */
     ...
     */
    connect(dataBase, &DataBase::sig_SendDataFromDB_TM, this, [this](QSqlTableModel*model){
        ui->tb_result->setModel(model);
    });
    connect(dataBase, &DataBase::sig_SendDataFromDB_QM, this, [this](QSqlQueryModel*model){
        ui->tb_result->setModel(model);
    });
...
void MainWindow::on_pb_request_clicked()
{
    ...
    case 1:
        ...
        break;
    case 2:
        dataBase->RequestToDB(reqComedy);
        break;
    case 3:
        dataBase->RequestToDB(reqHorror);
        break;
    }
}
